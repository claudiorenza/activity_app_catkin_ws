...
if(NOT "/home/kloudpix/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trigger_messages' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kloudpix/catkin_ws/src/trigger_messages/${idir}'.  ${_report}")
    endif()
